...
export const LoginForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#050a1a] px-4">
      ...
      >
        <h1 className="text-3xl font-bold text-center mb-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500">
          Admin Login
        </h1>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-[#0a1128] text-gray-400">Or continue with</span>
          </div>
        </div>
